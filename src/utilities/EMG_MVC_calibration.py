...
BASE_PATH = str(parent_dir) + r'\experiment\data\metabolic_cost'    # Define the base path for data storage
...
def main():
    ...
    df_noise.to_csv(f'{BASE_PATH}/MVC_baseline_noise.csv', index=False)
    df_mvc.to_csv(f'{BASE_PATH}/MVC_baseline_mvc.csv', index=False)
